...
This file also serves to **participant flow diagram** used in the manuscript.
...
about_data(baseline) # 1,432,448 observations and 136 variables
```
...
about_data(baseline_only) # 161,808 observations and 136 variables
```
...
about_data(baseline_only) # 161,808 observations and 38 variables
```
...
Keep only variables of interest (for analysis or MI) 
...
```{r}
readr::write_csv(baseline_only, "../data/baseline_only.csv")
```
