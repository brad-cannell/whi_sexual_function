...
**Note on Table 2:** Because it's only a few numbers, I will no longer create table 2 directly using an R markdown document. Instead, Julie created a table in Word, and I will just fill in the numbers manually using the analyses from this file below.
