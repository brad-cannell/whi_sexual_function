...
2. [Code used for preliminary variable management](/R notebooks/preprocess_01_read_sas.md)

3. [Code used to clean and manage abuse variables](/R notebooks/preprocess_01_read_sas.md)

4. [Code used to clean and manage sexual function variables](/R notebooks/preprocess_01_read_sas.md)

5. [Code used to clean and manage covariates of interest](/R notebooks/preprocess_01_read_sas.md)

6. [Code used to create baseline subset data](/R notebooks/preprocess_01_read_sas.md)

7. [Code used for multiple imputation](/R notebooks/preprocess_01_read_sas.md)
