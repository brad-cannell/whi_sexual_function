...
vars <- quos(race_eth_f, edu4cat_f, inc5cat_f, married_f, smoking_f, bmi, hyst_f, incont_f, good_health_f, 
             pshtdep, ssri_f, night_sweats_f, hot_flashes_f, vag_dry_f, hormnw_f)
